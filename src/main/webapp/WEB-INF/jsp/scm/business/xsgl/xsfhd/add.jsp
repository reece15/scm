...
<script type="text/javascript">
	$(document).ready(function(){
			...
			scmUtils.business.add.divProductFrame.divProdctFrameEvent();
			//声明一个事件，弹出的div的确定事件
			scmUtils.business.add.divProductFrame.divProductFrameSureEvent();
			//给行号声明右键事件
			scmUtils.business.add.addHhContextMenu();
			//声明当鼠标移出右键菜单的区域的时候，隐藏右键菜单的事件
			scmUtils.business.add.hideRMenu();
			//给右键菜单的增加菜单声明click事件
			scmUtils.business.add.rMenuClick();
			//给无税单价的input添加一个blur事件
			scmUtils.business.add.wsdjBlurEvent();
