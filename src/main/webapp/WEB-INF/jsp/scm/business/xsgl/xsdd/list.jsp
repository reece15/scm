...
<script type="text/javascript">
	$(document).ready(function(){
			...
			//点击主表中的某一行加载子表
			scmUtils.business.zhubTRClick();
			scmUtils.business.disPage.zhubDispageEvent();
			scmUtils.business.disPage.zhibDispageEvent();
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;" width="2000">
               ...
               <!-- 
               		创建一个隐藏域,保存点击的主表的id
                -->
                <s:hidden name="query_zhib.xsddzhubid"></s:hidden>
